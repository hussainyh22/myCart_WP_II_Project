            ...
            <div class="mobile-menu-bottom">
                ...
                <div class="offcanvas-menu">
                    <ul>
                        ...
                        <li class="has-dropdown">
                            <a class="active main-menu-link" href="localhost/privacy_policy.php">Privacy Policy</a>
                        </li>
                        <li>
                            <a href="#">About Us</a>
                        </li>
            ...
            <div class="row d-flex align-items-center justify-content-between d-sm-column">
                ...
                <div class="col-md-6">
                    <div class="content" data-aos="fade-up" data-aos-delay="200">
                        <h3 class="title">ABOUT OUR MYCART STORE</h3>
                        ...
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"
                                ...
                                <ul class="footer-nav">
                                    ...
                                    <li><a href="localhost/privacy_policy.php">Privacy Policy</a></li>
