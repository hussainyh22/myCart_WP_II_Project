...
<head>
    ...
    <title>MYCART-Privacy Policy</title>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-between">
                                ...
                                <nav>
                                    <ul>
                                        <li class="has-dropdown">
                                            <a class="active main-menu-link" href="/customer/products">Home</a>
                                        </li>
                                        <li class="has-dropdown">
                                        ...
                                        <li>
                                            <a href="/customer/contact_us">Contact Us</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                            ...
                            <ul class="header-action-link action-color--black action-hover-color--golden">
                                ...
                                <li><a href="/customer/myaccount">
                                    <button style="font-weight: bold;font-size: 22px;">Hello,<%=profile_name%></button></a>
                                </li>
                    ...
                    <div
                        ...
                        <div class="col-auto mb-6">
                            <div class="footer-copyright">
                                <p class="copyright-text">&copy; 2021 <a href="index.html">PARTH</a>. Made with <i
                                        class="fa fa-heart text-danger"></i> by <a href="https://PARTH.com/"
                                        target="_blank">PARTH</a> </p>
